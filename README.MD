...
## Useful links
- [Configuration file (config.yml)](https://github.com/Kredwi/GitHubAPIPlugin/blob/main/src/main/resources/config.yml)
- [GitHub REST API documentation (users)](https://docs.github.com/en/rest/users/users)

## License
This project is licensed under the **Apache License 2.0**.  
More details: [LICENSE](https://github.com/Kredwi/GitHubAPIPlugin/blob/main/LICENSE)