...
@Log
public class AsyncMySQLDatabase extends AbstractAsyncCache<String> {
    ...
    public void updateSession(@NotNull String sessionName, String linkeageUsername, Runnable afterLoad) {
        createSession(sessionName, () -> saveProfileRequest(sessionName, linkeageUsername), afterLoad);
    }

    public void createSession(@NotNull String sessionName,
                              @Nullable Runnable beforeLoad,
                              @Nullable Runnable callback) throws DatabaseValueNotFoundException {
